...
class ApartmentComplainAdapter : RecyclerView.Adapter<ApartmentComplainAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ApartmentComplainAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ApartmentComplainAdapter.ViewHolder, position: Int) {
        holder.bind(listOfComplains[position])
    }

    fun updateApartmentComplainList(complain: SingleComplaint) {
